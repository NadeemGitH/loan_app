                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Obx(() => Text(  dropDownController.employeeIndex.isEmpty ? "500-100" : "${dropDownController.employeeIndex}",
                              ...
                              onTap: (){
                                showModalBottomSheet(
                                  ...
                                  builder: (BuildContext context) {
                                    final List<String> items = ["300-200", "400-500"];
                                    ...
                                    return CustomBottomSheet(
                                      ...
                                      title: Text(''),
                                      items: items,
                                      onItemSelected: dropDownController.employeeIndex,
                                      shouldPop: true,
                                    );
