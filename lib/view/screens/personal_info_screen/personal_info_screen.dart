...
import 'package:waleed_project/view/screens/personal_info_screen/personal_info_two_screen.dart';
                ...
                children: [
                  ...
                  Container(
                    ...
                    child: Row(
                      ...
                      children: [
                        Obx(() => Text(  dropDownController.selectedGender.isEmpty ? "Male" : "${dropDownController.selectedGender}",
                        ...
                        GestureDetector(
                            onTap: (){
                              showModalBottomSheet(
                                ...
                                constraints: BoxConstraints.loose(Size.fromHeight(MediaQuery.of(context).size.height * 0.4)), // set max height to 40% of screen height
                                context: context,
                                builder: (BuildContext context) {
                                  final List<String> items = ["Male", "Female"];
                                  final double listItemHeight = 50.0; // set the height of each ListTile
                                  final double totalHeight = items.length * listItemHeight;
                                  return CustomBottomSheet(
                                    height: 140,
                                    title: Text(''),
                                    items: items,
                                    onItemSelected: dropDownController.selectedGender,
                                    shouldPop: true,
                                  );
                      ...
                      Expanded(
                        ...
                        child: Container(
                          ...
                          child: Row(
                            mainAxisAlignment: MainAxisAlignment.spaceBetween,
                            children: [
                              Obx(() => Text(  dropDownController.code.isEmpty ? "GHA" : "${dropDownController.code}",
                                style: const TextStyle(fontSize: 18.0,color: Color(
                                    0xff747070)),)),
                              GestureDetector(
                                  onTap: (){
                                      ...
                                      builder: (BuildContext context) {
                                        return Container(
                                          ...
                                          child: CustomBottomSheet(
                                            ...
                                            title: const Text(''),
                                            items: const ["RSA", "FRA"],
                                            onItemSelected: dropDownController.code,
                                            shouldPop: true,
                                          ),
                                        );
                                      },
