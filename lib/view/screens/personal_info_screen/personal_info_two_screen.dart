                  ...
                  children: [
                    ...
                    Container(
                      ...
                      child: Row(
                        ...
                        children: [
                          Obx(() => Text(  dropDownController.relationShip.isEmpty ? "Single" : "${dropDownController.relationShip}",
                              ...
                              onTap: (){
                                showModalBottomSheet(
                                  ...
                                  builder: (BuildContext context) {
                                    final List<String> items = ["Single", "Married"];
                                    ...
                                    return CustomBottomSheet(
                                      ...
                                      title: Text(''),
                                      items: items,
                                      onItemSelected: dropDownController.relationShip,
                                      shouldPop: true,
                                    );
                    ...
                    Container(
                      ...
                      child: Row(
                        mainAxisAlignment: MainAxisAlignment.spaceBetween,
                        children: [
                          Obx(() => Text(  dropDownController.religious.isEmpty ? "Christian" : "${dropDownController.religious}",
                            style: const TextStyle(fontSize: 18.0,color: Color(
                                0xff747070)),)),
                          GestureDetector(
                              onTap: (){
                                showModalBottomSheet(
                                  ...
                                  context: context,
                                  builder: (BuildContext context) {
                                    final List<String> items = ["Christian", "Muslim"];
                                    return CustomBottomSheet(
                                      height: 140,
                                      title: Text(''),
                                      items: items,
